...
class AppConstants {
  ...
  static const String appDescription = 'A modern news application built with Flutter';
  ...
  /// Error Messages
  static const String networkErrorMessage = 'Network error occurred. Please check your connection and try again.';
  static const String timeoutErrorMessage = 'Connection timed out. Please check your internet connection and try again.';
  static const String serverErrorMessage = 'Server error. Please try again later.';
  static const String invalidApiKeyMessage = 'Invalid API key. Please check your configuration.';
  ...
  static const String noCountryNewsMessage = 'No news available for the selected country';
  static const String noCategoryNewsMessage = 'No news available for the selected category';
  ...
  static const String searchTipsMessage = 'Use quotes for exact phrases, + for required words';
